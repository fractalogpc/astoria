...
public class CrafterController : MonoBehaviour, IStartExecution
{
  ...
  public void InitializeStart() {
    ...
    PlayerInventoryReference.Instance.Inventory.OnInventoryChange.AddListener(UpdateText);
  ...
  public void CreateObject() {
    ...
    foreach (var item in datas[Index].Cost) {
      PlayerInventoryReference.Instance.Inventory.TryRemoveItemByData(item.Item, item.Amount);
    }
  }
