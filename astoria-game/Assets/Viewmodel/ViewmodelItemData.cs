...
public class ViewmodelItemData : ItemData
{
	...
	[Tooltip("(OPTIONAL) The animator controller override for the HeldItemPrefab. If the prefab has animations, create an override of the ViewmodelAnimatorController and assign the prefab's animations in it. If these are assigned, the item will be parented to the viewmodel root.")]
