...
namespace TheVisualEngine
{
    public class TVEShaderManager : EditorWindow
    {
        ...
        void StyledShader(int index)
        {
            ...
            {
                var saveFolder = "Assets/BOXOPHOBIC+/The Visual Engine/Shaders";
                ...
                var newShaderPath = EditorUtility.SaveFilePanel("Save New Shader", saveFolder, shaderName + " (Custom)", "shader");
