...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsAtmoRaindrops
			...
			v2f vert ( appdata v )
			{
				...
				half temp_output_7_0_g23797 = _SeasonRemap.x;
				half temp_output_10_0_g23797 = ( _SeasonRemap.y - temp_output_7_0_g23797 );
				half TVE_SeasonLerp54_g23776 = saturate( saturate( ( ( TVE_SeasonLerp - temp_output_7_0_g23797 ) / temp_output_10_0_g23797 ) ) );
				...
				half2 vertexToFrag11_g23808 = ( ( lerpResult1899_g23776 * (_MainUVs).xy ) + (_MainUVs).zw );
				o.ase_texcoord1.yz = vertexToFrag11_g23808;
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half2 vertexToFrag11_g23808 = i.ase_texcoord1.yz;
				half4 MainTex_RGBA587_g23776 = tex2D( _MainTex, vertexToFrag11_g23808 );
				half3 temp_cast_0 = (0.0001).xxx;
				half3 temp_cast_1 = (0.9999).xxx;
				half3 clampResult17_g23802 = clamp( (MainTex_RGBA587_g23776).rgb , temp_cast_0 , temp_cast_1 );
				half temp_output_7_0_g23786 = _MainTexColorRemap.x;
				half3 temp_cast_2 = (temp_output_7_0_g23786).xxx;
				half temp_output_10_0_g23786 = ( _MainTexColorRemap.y - temp_output_7_0_g23786 );
				half3 temp_output_1765_0_g23776 = saturate( ( ( clampResult17_g23802 - temp_cast_2 ) / temp_output_10_0_g23786 ) );
				...
				half clampResult17_g23803 = clamp( (MainTex_RGBA587_g23776).a , 0.0001 , 0.9999 );
				half temp_output_7_0_g23785 = _MainTexAlphaRemap.x;
				half temp_output_10_0_g23785 = ( _MainTexAlphaRemap.y - temp_output_7_0_g23785 );
				half Element_Remap_A74_g23776 = saturate( ( ( clampResult17_g23803 - temp_output_7_0_g23785 ) / ( temp_output_10_0_g23785 + 0.0001 ) ) );
				half Element_Params_A1737_g23776 = _ElementParams_Instance.w;
				half clampResult17_g23783 = clamp( saturate( ( 1.0 - distance( (i.ase_texcoord2.xy*2.0 + -1.0) , float2( 0,0 ) ) ) ) , 0.0001 , 0.9999 );
				half temp_output_7_0_g23784 = _MainTexFalloffRemap.x;
				half temp_output_10_0_g23784 = ( _MainTexFalloffRemap.y - temp_output_7_0_g23784 );
				half Element_Falloff1883_g23776 = saturate( ( ( clampResult17_g23783 - temp_output_7_0_g23784 ) / ( temp_output_10_0_g23784 + 0.0001 ) ) );
				half temp_output_7_0_g23807 = 1.0;
				half temp_output_10_0_g23807 = ( _ElementVolumeFadeValue - temp_output_7_0_g23807 );
				half lerpResult18_g23805 = lerp( 1.0 , saturate( ( ( saturate( ( distance( WorldPosition , (TVE_RenderBasePositionR).xyz ) / (TVE_RenderBasePositionR).w ) ) - temp_output_7_0_g23807 ) / temp_output_10_0_g23807 ) ) , _ElementVolumeFadeMode);
				half Element_Alpha56_g23776 = ( _ElementIntensity * Element_Remap_A74_g23776 * Element_Params_A1737_g23776 * i.ase_color.a * Element_Falloff1883_g23776 * lerpResult18_g23805 );
...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsAtmoRaindrops
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half3 Input_Color94_g23795 = temp_cast_3;
				half3 break68_g23795 = Input_Color94_g23795;
				half clampResult80_g23795 = clamp( max( max( break68_g23795.x , break68_g23795.y ) , break68_g23795.z ) , 0.1 , 10000.0 );
				half4 color1877_g23776 = IsGammaSpace() ? half4(0,1,0,0) : half4(0,1,0,0);
				half3 Input_Tint76_g23795 = (color1877_g23776).rgb;
				half3 Element_Valid47_g23795 = ( clampResult80_g23795 * Input_Tint76_g23795 );
				half clampResult17_g23803 = clamp( (MainTex_RGBA587_g23776).a , 0.0001 , 0.9999 );
				half temp_output_7_0_g23785 = _MainTexAlphaRemap.x;
				half temp_output_10_0_g23785 = ( _MainTexAlphaRemap.y - temp_output_7_0_g23785 );
				half Element_Remap_A74_g23776 = saturate( ( ( clampResult17_g23803 - temp_output_7_0_g23785 ) / ( temp_output_10_0_g23785 + 0.0001 ) ) );
				...
				half Input_Alpha48_g23795 = Final_Extras_A241_g23776;
				half4 appendResult58_g23795 = (half4(Element_Valid47_g23795 , Input_Alpha48_g23795));
				
				
				finalColor = appendResult58_g23795;
				return finalColor;
			}
			ENDCG
		}
...
Node;AmplifyShaderEditor.FunctionNode;186;-512,-896;Inherit;False;Element Shader;10;;23776;0e972c73cae2ee54ea51acc9738801d0;12,477,3,1778,3,478,0,1824,0,1814,1,145,1,1784,2,1935,1,1933,1,481,2,1904,1,1907,1;1;1974;FLOAT;0;False;2;FLOAT4;0;FLOAT4;1779
...
ASEEND*/
//CHKSM=B82A129C3A2AC5AB1EC67F3FD284496F959EFD35