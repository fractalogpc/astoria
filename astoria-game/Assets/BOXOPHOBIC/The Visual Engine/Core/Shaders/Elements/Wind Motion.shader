...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsWindMotion
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half2 Direction_Transform1406_g76907 = (( mul( unity_ObjectToWorld, float4( float3(0,0,1) , 0.0 ) ).xyz / ase_objectScale )).xz;
				half4 MainTex_RGBA587_g76907 = tex2D( _MainTex, ( 1.0 - i.ase_texcoord1.xy ) );
				float3 temp_cast_2 = (0.0001).xxx;
				float3 temp_cast_3 = (0.9999).xxx;
				float3 clampResult17_g76932 = clamp( (MainTex_RGBA587_g76907).rgb , temp_cast_2 , temp_cast_3 );
				float temp_output_7_0_g76917 = _MainTexColorRemap.x;
				float3 temp_cast_4 = (temp_output_7_0_g76917).xxx;
				float temp_output_10_0_g76917 = ( _MainTexColorRemap.y - temp_output_7_0_g76917 );
				float3 temp_output_1765_0_g76907 = saturate( ( ( clampResult17_g76932 - temp_cast_4 ) / temp_output_10_0_g76917 ) );
				half Element_Remap_R73_g76907 = (temp_output_1765_0_g76907).x;
				half Element_Remap_G265_g76907 = (temp_output_1765_0_g76907).y;
				float3 appendResult274_g76907 = (float3((Element_Remap_R73_g76907*2.0 + -1.0) , 0.0 , (Element_Remap_G265_g76907*2.0 + -1.0)));
				float3 break281_g76907 = ( mul( unity_ObjectToWorld, float4( appendResult274_g76907 , 0.0 ) ).xyz / ase_objectScale );
				float2 appendResult1403_g76907 = (float2(break281_g76907.x , break281_g76907.z));
				half2 Direction_Texture284_g76907 = appendResult1403_g76907;
				float2 appendResult1404_g76907 = (float2(i.ase_color.r , i.ase_color.g));
				half2 Direction_VertexColor1150_g76907 = (appendResult1404_g76907*2.0 + -1.0);
				float2 appendResult1382_g76907 = (float2(i.ase_texcoord1.z , i.ase_texcoord2.x));
				half2 Direction_Velocity1394_g76907 = ( appendResult1382_g76907 / i.ase_texcoord2.y );
				float2 temp_output_1452_0_g76907 = ( ( _motion_direction_mode.x * Direction_Transform1406_g76907 ) + ( _motion_direction_mode.y * Direction_Texture284_g76907 ) + ( _motion_direction_mode.z * Direction_VertexColor1150_g76907 ) + ( _motion_direction_mode.w * Direction_Velocity1394_g76907 ) );
				half Element_InvertMode489_g76907 = _ElementInvertMode;
				float2 lerpResult1468_g76907 = lerp( temp_output_1452_0_g76907 , -temp_output_1452_0_g76907 , Element_InvertMode489_g76907);
				half2 Direction_Advanced1454_g76907 = lerpResult1468_g76907;
				half2 Motion_Coords2098_g76907 = -(( WorldPosition - TVE_WorldOrigin )).xz;
				half2 Motion_Tilling1409_g76907 = ( Motion_Coords2098_g76907 * 0.005 * _MotionTillingValue );
				float2 temp_output_3_0_g76929 = Motion_Tilling1409_g76907;
				float2 temp_output_21_0_g76929 = Direction_Advanced1454_g76907;
				float mulTime113_g76944 = _Time.y * 0.015;
				float lerpResult128_g76944 = lerp( mulTime113_g76944 , ( ( mulTime113_g76944 * TVE_TimeParams.x ) + TVE_TimeParams.y ) , TVE_TimeParams.w);
				float temp_output_1969_0_g76907 = (lerpResult128_g76944*_MotionSpeedValue + _MotionPhaseValue);
				float temp_output_15_0_g76929 = temp_output_1969_0_g76907;
				float temp_output_23_0_g76929 = frac( temp_output_15_0_g76929 );
				float4 lerpResult39_g76929 = lerp( tex2D( _MotionTex, ( temp_output_3_0_g76929 + ( temp_output_21_0_g76929 * temp_output_23_0_g76929 ) ) ) , tex2D( _MotionTex, ( temp_output_3_0_g76929 + ( temp_output_21_0_g76929 * frac( ( temp_output_15_0_g76929 + 0.5 ) ) ) ) ) , ( abs( ( temp_output_23_0_g76929 - 0.5 ) ) / 0.5 ));
				float4 temp_output_1423_0_g76907 = lerpResult39_g76929;
				half2 Motion_FlowRG1427_g76907 = (temp_output_1423_0_g76907).rg;
				half Motion_Noise2056_g76907 = _MotionNoiseValue;
				float2 lerpResult2090_g76907 = lerp( (Direction_Advanced1454_g76907*0.5 + 0.5) , Motion_FlowRG1427_g76907 , Motion_Noise2056_g76907);
				half Motion_Intensity2000_g76907 = _MotionIntensityValue;
				float2 lerpResult2138_g76907 = lerp( float2( 0.5,0.5 ) , lerpResult2090_g76907 , Motion_Intensity2000_g76907);
				half Motion_FlowA2144_g76907 = (temp_output_1423_0_g76907).a;
				float3 appendResult2047_g76907 = (float3(saturate( lerpResult2138_g76907 ) , ( Motion_FlowA2144_g76907 * Motion_Intensity2000_g76907 )));
				half3 Final_MotionWind_RGB2051_g76907 = appendResult2047_g76907;
				float clampResult17_g76933 = clamp( (MainTex_RGBA587_g76907).a , 0.0001 , 0.9999 );
				float temp_output_7_0_g76916 = _MainTexAlphaRemap.x;
				float temp_output_10_0_g76916 = ( _MainTexAlphaRemap.y - temp_output_7_0_g76916 );
				half Element_Remap_A74_g76907 = saturate( ( ( clampResult17_g76933 - temp_output_7_0_g76916 ) / ( temp_output_10_0_g76916 + 0.0001 ) ) );
				half4 _ElementParams_Instance = UNITY_ACCESS_INSTANCED_PROP(_ElementParams_arr, _ElementParams);
				half Element_Params_A1737_g76907 = _ElementParams_Instance.w;
				float clampResult17_g76914 = clamp( saturate( ( 1.0 - distance( (i.ase_texcoord1.xy*2.0 + -1.0) , float2( 0,0 ) ) ) ) , 0.0001 , 0.9999 );
				float temp_output_7_0_g76915 = _MainTexFalloffRemap.x;
				float temp_output_10_0_g76915 = ( _MainTexFalloffRemap.y - temp_output_7_0_g76915 );
				half Element_Falloff1883_g76907 = saturate( ( ( clampResult17_g76914 - temp_output_7_0_g76915 ) / ( temp_output_10_0_g76915 + 0.0001 ) ) );
				float temp_output_7_0_g76937 = 1.0;
				float temp_output_10_0_g76937 = ( _ElementVolumeFadeValue - temp_output_7_0_g76937 );
				float lerpResult18_g76935 = lerp( 1.0 , saturate( ( ( saturate( ( distance( WorldPosition , (TVE_RenderBasePositionR).xyz ) / (TVE_RenderBasePositionR).w ) ) - temp_output_7_0_g76937 ) / temp_output_10_0_g76937 ) ) , _ElementVolumeFadeMode);
				half Element_Alpha56_g76907 = ( _ElementIntensity * Element_Remap_A74_g76907 * Element_Params_A1737_g76907 * i.ase_color.a * Element_Falloff1883_g76907 * lerpResult18_g76935 );
				half Final_MotionWind_A2053_g76907 = Element_Alpha56_g76907;
				float4 appendResult1732_g76907 = (float4(Final_MotionWind_RGB2051_g76907 , Final_MotionWind_A2053_g76907));
				float4 temp_output_6_0_g76940 = appendResult1732_g76907;
				half Motion_Direction1013_g76907 = _MotionDirectionMode;
				#ifdef TVE_REGISTER
				float4 staticSwitch14_g76940 = ( temp_output_6_0_g76940 + ( Motion_Direction1013_g76907 * 0.0 ) );
				#else
				float4 staticSwitch14_g76940 = temp_output_6_0_g76940;
				#endif
				
				
				finalColor = staticSwitch14_g76940;
				return finalColor;
			}
			ENDCG
		}
...
#define _ElementParams_arr BOXOPHOBICTheVisualEngineElementsWindMotion
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float3 appendResult2047_g76907 = (float3(saturate( lerpResult2138_g76907 ) , ( Motion_FlowA2144_g76907 * Motion_Intensity2000_g76907 )));
				half3 Final_MotionWind_RGB2051_g76907 = appendResult2047_g76907;
				half3 Input_Color94_g76941 = Final_MotionWind_RGB2051_g76907;
				half3 Element_Valid47_g76941 = Input_Color94_g76941;
				float clampResult17_g76933 = clamp( (MainTex_RGBA587_g76907).a , 0.0001 , 0.9999 );
				float temp_output_7_0_g76916 = _MainTexAlphaRemap.x;
				float temp_output_10_0_g76916 = ( _MainTexAlphaRemap.y - temp_output_7_0_g76916 );
				half Element_Remap_A74_g76907 = saturate( ( ( clampResult17_g76933 - temp_output_7_0_g76916 ) / ( temp_output_10_0_g76916 + 0.0001 ) ) );
				...
				half Element_Alpha56_g76907 = ( _ElementIntensity * Element_Remap_A74_g76907 * Element_Params_A1737_g76907 * i.ase_color.a * Element_Falloff1883_g76907 * lerpResult18_g76935 );
				half Final_MotionWind_A2053_g76907 = Element_Alpha56_g76907;
				half Input_Alpha48_g76941 = Final_MotionWind_A2053_g76907;
				float4 appendResult58_g76941 = (float4(Element_Valid47_g76941 , Input_Alpha48_g76941));
				
				
				finalColor = appendResult58_g76941;
				return finalColor;
			}
			ENDCG
		}
...
Node;AmplifyShaderEditor.FunctionNode;621;-384,-768;Inherit;False;Element Shader;13;;76907;0e972c73cae2ee54ea51acc9738801d0;12,477,2,1778,2,478,0,1824,0,1814,3,145,3,1784,0,1935,1,1933,1,481,0,1904,0,1907,1;1;1974;FLOAT;0;False;2;FLOAT4;0;FLOAT4;1779
...
WireConnection;621;1974;574;4
WireConnection;417;0;621;0
WireConnection;418;0;621;1779
ASEEND*/
//CHKSM=E242C56699B137A4E9C436DF7C19D159B8D3C03E