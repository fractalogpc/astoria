...
namespace TheVisualEngine
{
    public class TVEAssetConverter : EditorWindow
    {
        ...
        //bool keepConvertedPrefabsSet = false;
        ...
        void DrawConversionButtons()
        {
            ...
            if (GUILayout.Button("Convert"))
            {
                ...
                for (int i = 0; i < prefabObjects.Count; i++)
                {
                    ...
                    {
                        //if (prefabData.isNested && !keepConvertedPrefabsSet)
                        //{
                        //    keepConvertedPrefabs = EditorUtility.DisplayDialog("Skip Converted Prefabs?", "Converted nested prefabs found! Would you like to keep the previously converted prefabs or reconvert and replace them?", "Skip Converted Prefabs", "Replace");

                        //    keepConvertedPrefabsSet = true;
                        //}
        ...
        void StyledPrefab(TVEPrefabData prefabData)
        {
            ...
            var iconExtra = new Rect(lastRect.width - 25, lastRect.y + 2, 20, 20);
            ...
            if (prefabData.status == TVEPrefabMode.Supported)
            {
                ...
                if (prefabData.hasOverrides)
                {
                    ...
                    GUI.Label(iconExtra, new GUIContent("", "The prefab instance has overrides! Make sure to apply/revert all overrides to avoid any conversion issues!"));
                }
            }
