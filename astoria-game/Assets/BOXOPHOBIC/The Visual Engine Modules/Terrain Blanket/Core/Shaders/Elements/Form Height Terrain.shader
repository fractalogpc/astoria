	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float temp_output_10_0_g23063 = ( _ElementVolumeFadeValue - temp_output_7_0_g23063 );
				float lerpResult18_g23061 = lerp( 1.0 , saturate( ( ( saturate( ( distance( WorldPosition , (TVE_RenderBasePositionR).xyz ) / (TVE_RenderBasePositionR).w ) ) - temp_output_7_0_g23063 ) / temp_output_10_0_g23063 ) ) , _ElementVolumeFadeMode);
...
ASEEND*/
//CHKSM=4E9C700B72A26181AA827107371BA391EB0CB28D