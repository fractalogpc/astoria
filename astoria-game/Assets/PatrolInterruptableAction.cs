...
[NodeDescription(name: "PatrolInterruptable", story: "[Agent] patrols [waypoints] until distance to [object] is less than [lessthan] than [number]", category: "Action/Navigation", id: "1a5be50e49a7277021b57be7045a1288")]
public partial class PatrolInterruptableAction : Action
{
    [SerializeReference] public BlackboardVariable<List<GameObject>> Waypoints;
    [SerializeReference] public BlackboardVariable<GameObject> Object;
    [SerializeReference] public BlackboardVariable<float> Number;
    [SerializeReference] public BlackboardVariable<GameObject> Agent;
    [SerializeReference] public BlackboardVariable<bool> Lessthan;
    ...
    protected override Status OnUpdate()
    {
        ...
        float distanceToObject = Vector3.Distance(Agent.Value.transform.position, Object.Value.transform.position);
        if (Lessthan) {
            if (distanceToObject < Number) {
