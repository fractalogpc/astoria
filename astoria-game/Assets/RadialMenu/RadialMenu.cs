...
public class RadialMenu : InputHandlerBase
{
	...
	/// </summary>
	public static event RadialElementParam OnElementSelected;
	/// <summary>
	/// Invoked when the user hovers over a new element. Will pass the hovered element.
	/// </summary>
	public static event RadialElementParam OnElementHovered;
	...
	private void Update() {
		...
		float setAngle = Mathf.LerpAngle(_selectorElement.rotation.eulerAngles.z - _selectorVisualOffset, _targetAngle, Time.deltaTime * _selectorSnappiness);
